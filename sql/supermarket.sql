...
INSERT INTO pedido (id, data_pedido, id_cliente, id_forma_pagamento) VALUES (3, '2024-12-14 10:40:00', 8, 1);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (3, 1, 7890000000010, 10, 8.99);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (3, 2, 7890000000001, 1, 8.90);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (3, 3, 7890000000003, 5, 6.00);

INSERT INTO pedido (id, data_pedido, id_cliente, id_forma_pagamento) VALUES (4, '2024-05-14 10:40:00', 7, 2);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (4, 1, 7890000000009, 10, 17.49);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (4, 2, 7890000000001, 3, 8.90);

INSERT INTO pedido (id, data_pedido, id_cliente, id_forma_pagamento) VALUES (5, '2024-08-12 10:40:00', 2, 4);
INSERT INTO item_pedido (id_pedido, sequencial, codigo_barra, quantidade, valor_unitario) VALUES (5, 1, 7890000000012, 3, 21.99);
...
-- agrupar por clientes e mostrar informacoes de pedidos
SELECT
	cliente_pf.nome,
	id_pedido,
...
INNER JOIN produto ON (item_pedido.codigo_barra = produto.codigo_barra)
INNER JOIN cliente_pf ON (pedido.id_cliente = cliente_pf.id)
INNER JOIN forma_pagamento ON (pedido.id_forma_pagamento = forma_pagamento.id)
GROUP BY forma_pagamento.nome, id_pedido, cliente_pf.nome



-- agrupar por forma de pagamento e mostrar detalhes relacionados
SELECT
	forma_pagamento.nome,
	COUNT(DISTINCT pedido.id_cliente),
	SUM(item_pedido.quantidade * item_pedido.valor_unitario) as valor_total
...
INNER JOIN cliente_pf ON (pedido.id_cliente = cliente_pf.id)
INNER JOIN forma_pagamento ON (pedido.id_forma_pagamento = forma_pagamento.id)
GROUP BY forma_pagamento.nome, pedido.id_forma_pagamento





-- categoria, quantidade de produtos vinculados
SELECT categoria.nome AS categoria, COUNT(produto.id_categoria) AS quantidade
FROM produto
